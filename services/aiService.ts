...
export const generateMarketingStrategy = async (
    ...
    try {
        ...
        if (textModel.provider === 'google') {
            ...
            let endpoint = textModel.baseUrl?.replace(/\/$/, '') || '';

            // 🛡️ Grsai/Jiekou fixes
            // ... (keep existing endpoint normalization logic) ...
            ...
            // Store ORIGINAL endpoint for Universal Proxy Fallback
